...
pub const MIDGAME_DEFENSE_SOLUTIONS_MAX: u32 = 80_000;
pub const MIDGAME_DEFENSE_DIFFICULTY_MAX: Option<u32> = Some(5000);
...
pub const ENDGAME_DEFENSE_DIFFICULTY_MAX: Option<u32> = Some(10000);

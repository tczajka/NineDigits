...
pub const ENDGAME_OFFENSE_EXTENDED_TIME_FRACTION: f64 = 0.40;
...
pub const MIDGAME_DEFENSE_DIFFICULTY_MAX: Option<u32> = Some(10_000);

// Endgame.
pub const ENDGAME_CHECK_TIME_NODES: u64 = 1024;
pub const TRANSPOSITION_TABLE_MEMORY: usize = 512 << 20;
pub const ENDGAME_OFFENSE_DIFFICULTY_MAX: Option<u32> = Some(10_000);
pub const ENDGAME_DEFENSE_DIFFICULTY_MAX: Option<u32> = Some(10_000);
